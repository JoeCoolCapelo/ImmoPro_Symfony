 ...
 */
final class Version20260604125621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE biens CHANGE views_count views_count INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE biens CHANGE views_count views_count INT NOT NULL');
